...
$stmt = $pdo->prepare("SELECT * FROM news WHERE type = 'Top News'");
$stmt->execute();
...
<body style="background: #fff0f7;">
    ...
    <div style="padding-left: 30px; padding-right: 31px;">
        <h2 class="text-center" style="margin-bottom: 25px;">Top News</h2> 
    ...
    <div class="row row-cols-1 row-cols-md-4 g-5" style="padding-top: 12px;">
        ...
        ?>
            <div class="col">
                <div class="card"> <!-- Removed class for smaller cards -->
