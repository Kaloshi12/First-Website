        ...
        <table class="content-table">
            ...
            <?php
                ...
                while ($row = $stmt->fetch()) {
                    ...
                    echo '<td> <form method="POST" action="removemoderatorprocess.php"> <input type="hidden" name="id" value="' . $row['id'] . '"> <button class="remove" type="submit" name="button">X</button> </form></td>';
                    echo '</tr>';
                }
                ?>
            </tbody>
